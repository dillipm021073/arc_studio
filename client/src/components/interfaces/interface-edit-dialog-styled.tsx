        ...
        <DialogContent className="max-w-5xl max-h-[90vh] overflow-y-auto bg-gray-800 border-gray-700">
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              {initialInterface && (
                <div className="space-y-4">
                  <h3 className="text-lg font-semibold border-b border-gray-600 pb-2 text-white">Business Process Usage</h3>
                  <div className="p-4 bg-gray-700 rounded-lg">
                    <p className="text-sm text-gray-300 mb-3">This interface is used by the following business processes:</p>
                    <InterfaceBusinessProcesses interfaceId={initialInterface.id} />
                  </div>
                </div>
              )}
