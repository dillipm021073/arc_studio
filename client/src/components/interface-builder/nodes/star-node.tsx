...
export interface StarNodeData {
  ...
  innerRadius?: number; // Inner radius as percentage of outer radius
  onDelete?: () => void;
  onDuplicate?: () => void;
...
function StarNode({ data, selected }: NodeProps<StarNodeData>) {
  ...
  const numPoints = data.points || 5;
  const innerRadius = data.innerRadius || 0.4; // Inner radius is 40% of outer radius
